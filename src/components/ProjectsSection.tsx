...
import { Sparkles, Code2, Cpu, Eye, Layers } from "lucide-react";

export default function ProjectsSection() {
  const [selectedCategory, setSelectedCategory] = useState<"All" | "ML/AI" | "Computer Vision">("All");

  const categories: ("All" | "ML/AI" | "Computer Vision")[] = [
    "All",
    "ML/AI",
    "Computer Vision"
  ];
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div className="space-y-2">
            ...
            <p className="text-text-muted text-sm max-w-xl transition-colors duration-300">
              Highly technical, end-to-end full-stack AI and Computer Vision pipelines.
            </p>
          </div>
        </div>
